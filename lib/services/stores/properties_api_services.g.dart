...
part of 'properties_api_services.dart';
...
class _PropertiesApiService implements PropertiesApiService {
  ...
  Future<PropertyDto> getPropertyDetail(
    ...
    final _options = _setStreamType<PropertyDto>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/${role}/properties/property/${propertyId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<PropertyDto> getBuyerPropertyDetail(String propertyId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<PropertyDto>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/pembeli/properties/property/${propertyId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
